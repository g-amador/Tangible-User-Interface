package com.oaxoa.misc
{
	...
	public class  LavaLamp extends Sprite {
		...
		private function initBmp():void {
			...
			TouchAll._background.addEventListener(TuioTouchEvent.TOUCH_MOVE, touchChangeThreshold);
		}
		...
		private function initFilters():void {
			...
			TouchAll._background.addEventListener(TuioTouchEvent.DOUBLE_TAP, switchFilters);
		}
		...
		private function touchChangeThreshold(event:TuioTouchEvent):void {
