...
{	
	...
	public class VideoMenu extends MovieClip
	{
		...
		public function VideoMenu(ns:NetStream = null, path:String = "", x:uint = 0, y:uint = 0) 
		{
			...
			playButton.addEventListener(TuioTouchEvent.TOUCH_UP, playButtonUp);
			playButton.addEventListener(TuioTouchEvent.TOUCH_DOWN, playButtonDown);
			stopButton.addEventListener(TuioTouchEvent.TOUCH_UP, stopButtonUp);
			stopButton.addEventListener(TuioTouchEvent.TOUCH_DOWN, stopButtonDown);
			pauseButton.addEventListener(TuioTouchEvent.TOUCH_UP, pauseButtonUp);
			pauseButton.addEventListener(TuioTouchEvent.TOUCH_DOWN, pauseButtonDown);
			volumeUpButton.addEventListener(TuioTouchEvent.TOUCH_UP, volumeUpButtonUp);
			volumeUpButton.addEventListener(TuioTouchEvent.TOUCH_DOWN, volumeUpButtonDown);
			volumeDownButton.addEventListener(TuioTouchEvent.TOUCH_UP, volumeDownButtonUp);
			volumeDownButton.addEventListener(TuioTouchEvent.TOUCH_DOWN, volumeDownButtonDown);
