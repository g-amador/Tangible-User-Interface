package touchAll.cube3D
{
	...
	public class Cube3D
	{
		...
		public function Cube3D(_stage:Stage = null):void 
		{
			...
			spBoard.addEventListener(TuioTouchEvent.TOUCH_MOVE, touchBoardMove);
			spBoard.addEventListener(TuioTouchEvent.TOUCH_DOWN, touchBoardDown);
			spBoard.addEventListener(TuioTouchEvent.TOUCH_UP, boardUp);			
		...
		private function touchBoardDown(e:TuioTouchEvent):void {
			prevX=e.stageX;
			prevY=e.stageY;
			velX=0;
			velY=0;
		...
		private function touchBoardMove(e:TuioTouchEvent):void {
			var locX:Number=prevX;
			var locY:Number=prevY;
