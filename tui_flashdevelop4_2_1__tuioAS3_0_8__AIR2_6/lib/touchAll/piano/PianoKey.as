...
package touchAll.piano
{
	...
	public class PianoKey extends Sprite {		
		...
		public function PianoKey(key:int, midi_key:int, white_keys_color:uint = 0xFEFEFE) {
			...
			this.addEventListener(TuioTouchEvent.TOUCH_DOWN, touchPress);
		}
		...
		public function touchPress(e:TuioTouchEvent):void {
			key_down.visible = true;
			key_up.visible = false;
			this.addEventListener(TuioTouchEvent.TOUCH_UP, touchRelease);
			this.stage.addEventListener(TuioTouchEvent.TOUCH_UP, touchRelease);			
			sindex = 0;
			last = 0;
			fade_out = 1;
			if (sound_channel == null){
		...
		public function touchRelease(e:TuioTouchEvent):void {
			this.removeEventListener(TuioTouchEvent.TOUCH_UP, touchRelease);
			this.stage.removeEventListener(TuioTouchEvent.TOUCH_UP, touchRelease);
			key_down.visible = false;
			key_up.visible = true;			
		}
