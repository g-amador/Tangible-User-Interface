package touchAll.multimedia
{
	...
	public class Multimedia implements IMultimedia 
	{
		...
		public function backgroundMultimediaEventListenersLoader():void {
			...
			_background.addEventListener(TouchEvent.DOUBLE_TAP, sortMultimedia);
			//_background.addEventListener(TouchEvent.TAP, touchImageFileExplorer);			
		}
		...
		public function imageEventListenersLoader(image:Sprite):void {
			...
			image.addEventListener(TouchEvent.DOUBLE_TAP, zoomInOutMultimedia);
		...
		public function videoEventListenersLoader(video:MovieClip):void {
			...
			video.addEventListener(TouchEvent.DOUBLE_TAP, zoomInOutMultimedia);
		 ...
		 */
		private function tuioManagerTouchZoomInOutMultimedia(e:TouchEvent):void {
