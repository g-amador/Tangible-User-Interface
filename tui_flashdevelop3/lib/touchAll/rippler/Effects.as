...
package touchAll.rippler
{
	...
	public class Effects extends Sprite
	{
		...
		public function backgroundRippleEventListenersLoader():void {
			...
			TouchAll._background.addEventListener(TouchEvent.TOUCH_UP, touchRipple);
			TouchAll._background.addEventListener(TouchEvent.TOUCH_MOVE, touchRipple);
			TouchAll._background.addEventListener(TouchEvent.TOUCH_MOVE, touchRainIntensity);
			TouchAll._background.addEventListener(TouchEvent.DOUBLE_TAP, toggleRainOnOff);
		 ...
		 */
		private function touchRipple(e:TouchEvent):void {
		 ...
		 */
		private function touchRainIntensity(e:TouchEvent):void {
